...
const Profile = () => {
  ...
  return (
    <motion.div
      ...
      className='min-h-svh flex flex-col justify-center items-center lg:flex-row'
    >
      <div className='flex flex-col h-svh lg:w-1/2 justify-center items-center'>
        <img
        ...
        >
          ...
          <br></br>
          <p>Atualmente, estou cursando Ciência da Computação na Universidade La Salle, e sou formado no curso de desenvolvimento web full stack da Trybe, onde desenvolvi projetos que incluem, entre outras, as tecnologias HTML, CSS, JavasCript, React, Redux, Node.Js, Docker, Express, TypeScript, MySQL, MongoDB e Python, além de conceitos como SOLID, REST, padrões de projeto, raspagem de dados, algoritmos e estruturas de dados.</p>
          <br></br>
      ...
      <section
        className='lg:w-1/2 h-svh text-white p-10 indent-5 tracking-wider justify-center text-justify flex flex-col '
      >
